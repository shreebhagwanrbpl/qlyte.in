...
const ProductLink = memo(function ProductLink({ item, category, scrollToProduct }) {
  return (
    <button
      ...
      className="block w-full text-left py-1 text-sm text-slate-500 hover:text-[#C89200] hover:translate-x-1 transition-all duration-200 font-medium"
    >
      • {item.title}
    </button>
  );
  ...
  return (
    <div className="space-y-2 pl-2">
      ...
      <button
        ...
        className="w-full text-left py-1.5 flex justify-between items-center text-xs font-bold text-[#C89200] ring-[#C89200] transition-colors uppercase tracking-wider border-b border-slate-100 pb-1"
      >
        <span className="flex items-center gap-1.5">
          <span className={`transition-transform duration-200 ${isSubOpened ? "rotate-90" : ""}`}>
            <ChevronRight size={12} className="text-[#C89200]" />
          </span>
          {subCategory}
        </span>
        <span className="text-[10px] font-semibold bg-[#F8E8B5] text-[#C89200] px-1.5 py-0.5 rounded-full">
          {subList.length}
        </span>
      </button>
    ...
    <div className="group">
      <button
        ...
        className={`sticky top-[116px] z-10 w-full px-4 py-3 flex justify-between items-center rounded-2xl transition-all duration-200 text-left ${isActive
          ? "bg-[#F8E8B5] text-[#C89200] font-bold"
          : "bg-white text-slate-700 hover:bg-slate-50 hover:text-[#C89200]"
          }`}
      >
        <span className="flex items-center gap-3 text-sm font-semibold leading-none">
          <span className={`transition-transform duration-200 ${isOpened ? "rotate-90" : ""}`}>
            <ChevronRight size={16} className={isActive ? "text-[#C89200]" : "text-slate-400 group-hover:text-[#C89200]"} />
          </span>
          {category}
        </span>
        <span className={`text-xs font-semibold px-2 py-0.5 rounded-full ${isActive ? "bg-[#F4D97A] text-[#A97A00]" : "bg-slate-100 text-slate-500"
          }`}>
          {categoryProductCount}
        </span>
      </button>
  ...
  return (
    <Profiler id="ProductsLayout" onRender={onRenderCallback}>
      ...
      <section className="section-padding bg-white">
        ...
        <div className="max-w-2xl mx-auto mt-6 lg:mt-10 px-4 lg:px-0 relative">
          ...
          <input
            ...
            className="w-full h-16 pl-14 pr-5 rounded-2xl border border-slate-200 bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-[#C89200]"
          />
        </div>
            ...
            <div className="sticky top-0 -mx-6 pt-6 px-6 pb-3 bg-white z-20 border-b border-slate-100 mb-4 h-[116px]">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full h-10 pl-10 pr-4 rounded-xl border border-slate-200 bg-slate-50 text-sm focus:outline-none focus:ring-2 focus:ring-[#C89200] focus:bg-white transition-all"
                />
              </div>
            </div>
          ...
          <div className="space-y-16">
            {filteredProducts.length === 0 ? (
              <div className="bg-white border border-slate-200 rounded-[32px] p-10 lg:p-16 text-center shadow-lg">
                <div className="w-24 h-24 mx-auto rounded-full bg-[#F4D97A] flex items-center justify-center text-5xl mb-6">
                  🔍
                </div>
                ...
                <button
                  ...
                  className="mt-8 px-8 py-3 rounded-xl bg-[#C89200] text-white font-semibold hover:bg-[#A97A00] transition"
                >
                  View All Products
                </button>
              </div>
        ...
        <div className="container-custom">
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8 mt-16">
            {[
              ...
              >
                <div className="w-16 h-16 mx-auto rounded-[22px] bg-[#F4D97A] text-[#C89200] flex items-center justify-center mb-6">
                  {item.icon}
                </div>
      ...
      {showTopButton && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 z-50 w-14 h-14 rounded-full bg-[#C89200] text-white shadow-2xl hover:scale-110 transition flex items-center justify-center"
        >
          <ChevronUp size={24} />
        </button>
      )}
